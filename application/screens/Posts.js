...
export default class Posts extends Component {
  ...
  componentDidMount() {
    ...
    var request_1_url = configs.baseURL + 'json/data_posts.php';
    var request_2_url = configs.baseURL + 'json/data_tags.php';
          ...
          <SwiperFlatList
            ...
            renderItem={({ item }) =>
              <TouchableOpacity onPress={() => this.PostDetails(item)} activeOpacity={1}>
                <ImageBackground source={{ uri: configs.baseURL + 'images/' + item.post_image }} style={styles.background_diets}>
