...
export default class Categories extends Component {
  ...
  componentDidMount() {
       ...
       return fetch(configs.baseURL+'json/data_categories.php')
...
<FlatList
          ...
          renderItem={({item}) =>
            ...
            <ListItem style={{paddingLeft: 0, marginLeft: 0, backgroundColor:'#FFF', opacity: 1, borderColor: 'rgba(0,0,0,0.05)', borderBottomWidth: 1}}  onPress={this.DietsByCategory.bind(this, item.category_id, item.category_title)} >
              <Thumbnail rounded size={80} source={{ uri: configs.baseURL+'images/'+item.category_image }} style={{paddingLeft: 10, marginLeft: 10}} />
