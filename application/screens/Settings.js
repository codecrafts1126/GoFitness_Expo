        ...
        <ScrollView>
          ...
          <View style={{ padding: 45, paddingTop: 30 }}>
            <List>
              ...
              <ListItem icon style={{ marginLeft: 0, borderBottomWidth: 0 }} onPress={this.navigateToScreen('LangaugeScreen')}>
                <Left style={{ borderBottomWidth: 0 }}></Left>
                <Body style={{ borderBottomWidth: 0 }}>
                  <Text>{Strings.ST107}</Text>
                </Body>
                <Right style={{ borderBottomWidth: 0 }}></Right>
              </ListItem>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center', alignContent: 'center', alignItems: 'center', paddingTop: 10 }}>
            <TouchableOpacity onPress={() => { Linking.openURL('https://facebook.com') }}><Icon name="facebook-with-circle" style={{ fontSize: 46, width: 50, height: 50 }} color="#4284d5" /></TouchableOpacity>
            <TouchableOpacity onPress={() => { Linking.openURL('https://youtube.com') }}><Icon name="youtube-with-circle" style={{ fontSize: 46, width: 50, height: 50 }} color="#4284d5" /></TouchableOpacity>
            <TouchableOpacity onPress={() => { Linking.openURL('https://twitter.com') }}><Icon name="twitter-with-circle" style={{ fontSize: 46, width: 50, height: 50 }} color="#4284d5" /></TouchableOpacity>
            <TouchableOpacity onPress={() => { Linking.openURL('https://instagram.com') }}><Icon name="instagram-with-circle" style={{ fontSize: 46, width: 50, height: 50 }} color="#4284d5" /></TouchableOpacity>
