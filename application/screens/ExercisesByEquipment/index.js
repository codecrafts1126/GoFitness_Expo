...
class ExercisesByEquipment extends React.Component {
    constructor() {
        super();
        this.state = {
            isLoading: true,
    ...
    componentDidMount() {
        ...
        return fetch(configs.baseURL + 'json/data_equipment.php?equipment=' + this.props.navigation.state.params.IdEquipment)
            ...
            <Container style={styles.container}>
                <Header style={styles.header}>
                    ...
                    <Body style={{ flex: 4, justifyContent: 'center', alignItems: 'center' }} >
                        <Title style={{ fontSize: 20, color: colors.white }}>{this.props.navigation.state.params.TitleEquipment}</Title>
                    </Body>
                    <Right style={{ flex: 1 }} >
                        {isRTL ?
...
export default connect(mapStateToProps, undefined)(ExercisesByEquipment);