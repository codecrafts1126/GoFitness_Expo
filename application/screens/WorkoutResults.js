...
export default class WorkoutResults extends Component {
  ...
  return (
    <View style={{alignItems: 'center', flexDirection: 'column', justifyContent: 'center', alignContent: 'center',  marginTop: 60}}>
      ...
      <TouchableOpacity style={{backgroundColor: '#fff', borderWidth: 1, borderColor: '#4284d5', padding: 10, borderRadius: 4, paddingLeft: 15, paddingRight: 15}} onPress={() => this.props.navigation.goBack()}>
      <Text style={{color: '#4284d5'}}>{Strings.ST25}</Text>
      </TouchableOpacity>
    </View>
   );
};
