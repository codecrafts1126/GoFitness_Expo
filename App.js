...
export default class App extends React.Component {
  ...
  async _loadAssetsAsync() {
    const imageAssets = cacheImages([
      ...
      require('./assets/images/male-disable.png'),
      require('./assets/images/male-enable.png'),
      require('./assets/images/female-disable.png'),
      require('./assets/images/female-enable.png'),
    ]);
